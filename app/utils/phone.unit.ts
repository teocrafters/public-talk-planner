...
describe("formatPhoneNumber", () => {
  ...
  it("throws error for invalid length (too short)", () => {
    expect(() => formatPhoneNumber("12345")).toThrow("Phone number must be exactly 9 digits")
    expect(() => formatPhoneNumber("1234567")).toThrow("Phone number must be exactly 9 digits")
  })

  it("throws error for invalid length (too long)", () => {
    expect(() => formatPhoneNumber("1234567890")).toThrow("Phone number must be exactly 9 digits")
    expect(() => formatPhoneNumber("12345678901")).toThrow("Phone number must be exactly 9 digits")
  })

  it("throws error for empty string", () => {
    expect(() => formatPhoneNumber("")).toThrow("Phone number must be exactly 9 digits")
  })

  it("throws error for null or undefined", () => {
    expect(() => formatPhoneNumber(null as any)).toThrow("Phone number must be exactly 9 digits")
  ...
  it("rejects formatted input (expects unformatted 9 digits)", () => {
    expect(() => formatPhoneNumber("123-456-789")).toThrow("Phone number must be exactly 9 digits")
  })
})
