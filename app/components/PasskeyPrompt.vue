<template>
  <div v-if="show" class="fixed top-4 right-4 max-w-md z-50">
    <UCard class="shadow-lg">
      ...
      <div class="space-y-4">
        ...
        <div class="flex space-x-2">
          <UButton size="sm" :loading="loading" @click="setupPasskey">
            {{ t('passkey.setupNow') }}
          </UButton>
          <UButton variant="outline" size="sm" @click="remindLater">
